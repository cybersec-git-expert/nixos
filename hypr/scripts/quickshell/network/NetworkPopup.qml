...
Item {
    ...
    readonly property color glassTintAccent: _theme.glassTintAccent
    readonly property color glassBorder: _theme.glassBorder

    // Wi-Fi vs Bluetooth still read as two states, but both hues come from the same wallpaper primary.
    readonly property color wifiAccent: window.blue
    readonly property color btAccent: Qt.lighter(window.blue, 1.16)

    function canvasRgba(c, a) {
        ...
        Rectangle {
                ...
                onPaint: {
                    ...
                    for (var i = 0; i < orbitRepeater.count; i++) {
                        ...
                        function drawStrands(startX, startY, parentFade, parentWidth) {
                            ...
                            ctx.strokeStyle = window.canvasRgba(window.text, 1.0);
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        ...
                                        color: isMyDisconnecting ? window.overlay1 : (coreMa.containsMouse ? window.crust : Qt.rgba(window.crust.r, window.crust.g, window.crust.b, 0.55))
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                color: locksList ? window.glassTintAccent : window.glassFillHover
                                Behavior on color { ColorAnimation { duration: 200 } }
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle { width: 1; Layout.fillHeight: true; Layout.margins: window.s(5); color: Qt.rgba(window.text.r, window.text.g, window.text.b, 0.2) }
