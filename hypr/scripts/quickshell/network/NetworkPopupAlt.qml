...
Item {
    ...
    readonly property color ethAccent: Qt.lighter(window.blue, 1.12)
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    color: coreMa.containsMouse ? window.crust : Qt.rgba(window.crust.r, window.crust.g, window.crust.b, 0.55)
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                anchors.fill: parent
                                radius: window.s(14)
                                color: floatMa.containsMouse ? window.glassTintAccent : window.glassFillHover
                                Behavior on color { ColorAnimation { duration: 200 } }
