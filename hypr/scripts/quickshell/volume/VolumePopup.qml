...
Item {
    ...
    readonly property color glassFill: _theme.glassFill
    readonly property color glassFillHover: _theme.glassFillHover
    readonly property color glassFillStrong: _theme.glassFillStrong
    readonly property color glassBorder: _theme.glassBorder
    ...
    Item {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                opacity: 0.04
                color: Qt.lighter(window.blue, 1.3)
                Behavior on color { ColorAnimation { duration: 800 } }
            }
            ...
            ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                radius: width / 2
                                color: "transparent"
                                border.color: window.activeMute ? window.red : window.blue
                            ...
                            Rectangle {
                                ...
                                height: width
                                radius: width / 2
                                color: window.activeMute ? window.red : window.blue
                            ...
                            Rectangle {
                                ...
                                radius: width / 2
                                color: window.base
                                border.color: window.activeMute ? window.red : Qt.lighter(window.blue, 1.1)
                                border.width: 2
                                clip: true
                                ...
                                Canvas {
                                    ...
                                    Connections {
                                        ...
                                        function onBlueChanged() { orbWave.requestPaint() }
                                    }
                                    ...
                                    onPaint: {
                                        ...
                                        if (window.activeMute) {
                                            ...
                                            grad.addColorStop(0, Qt.lighter(window.blue, 1.15).toString());
                            ...
                            RowLayout {
                                ...
                                Item {
                                    ...
                                    Rectangle {
                                        ...
                                        color: window.glassFillStrong; border.color: window.glassBorder; border.width: 1
                                        clip: true
                                        ...
                                        Rectangle {
                                            ...
                                            gradient: Gradient {
                                                ...
                                                GradientStop { position: 0.0; color: window.activeMute ? window.surface2 : window.blue; Behavior on color { ColorAnimation{duration: 300} } }
                                                GradientStop { position: 1.0; color: window.activeMute ? Qt.lighter(window.surface2, 1.15) : Qt.lighter(window.blue, 1.25); Behavior on color { ColorAnimation{duration: 300} } }
                                            }
                                        }
                                    }
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        gradient: Gradient {
                            orientation: Gradient.Horizontal
                            GradientStop { position: 0.0; color: window.blue; Behavior on color { ColorAnimation { duration: 400 } } }
                            GradientStop { position: 1.0; color: Qt.lighter(window.blue, 1.15); Behavior on color { ColorAnimation { duration: 400 } } }
                        }
                    }
                ...
                Item {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            color: isActiveNode ? window.blue : (isHovered ? window.glassFillHover : window.glassFill)
                            border.color: isActiveNode ? window.blue : window.glassBorder
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        color: muteMa.containsMouse ? window.glassBorder : "transparent"
                                        border.color: muteMa.containsMouse ? (model.mute ? window.overlay0 : window.blue) : "transparent"
                                    ...
                                    Item {
                                        ...
                                        Rectangle {
                                            ...
                                            Rectangle {
                                                ...
                                                gradient: Gradient {
                                                    orientation: Gradient.Horizontal
                                                    GradientStop { position: 0.0; color: model.mute ? window.surface2 : window.blue; Behavior on color { ColorAnimation { duration: 300 } } }
                                                    GradientStop { position: 1.0; color: model.mute ? Qt.lighter(window.surface2, 1.15) : Qt.lighter(window.blue, 1.25); Behavior on color { ColorAnimation { duration: 300 } } }
                                                }
                                            }
                                        }
