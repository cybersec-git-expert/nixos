...
PanelWindow {
    ...
    // Same primary output as Main.qml / TopBar — toast popups stay on the HP panel.
    ...
    screen: {
        ...
        const want = popupWindow.primaryHyprOutput;
    ...
    margins {
        bottom: popupWindow.layoutConfig.marginBottom
    ...
    // Shared frosted tint (matches Main.qml / TopBar.qml)
    ...
    Item {
        ...
        // Unified frosted surface behind toast list.
        Rectangle {
            anchors.fill: parent
            color: popupWindow.frostTint
    ...
    // Compositor blur behind toasts (ext-background-effect-v1).
    // Hyprland layerrule blur also applies to this layer surface.
    BackgroundEffect.blurRegion: Region { item: contentWrapper }
}
